...
class adding_a_coach_Screen extends StatelessWidget {
  ...
  final Adding_a_coach_controller _controller =
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              DropDownButton(
                  hint: "coach status",
                  list: _controller.CoachStatus,
                  value: _controller.selectedCoachStatus),
              ...
              DropDownButton(
                  ...
                  list: _controller.ProfessionalDegree,
                  value: _controller.selectedProfessionalDegree),
              const SizedBox(height: 16),
              MyTextFormField(
                  validator: () {},
              ...
              MyTextFormField(
                  ...
                  prefixIcon: Image.asset("assets/images/yellow_check.png"),
                  controller: _controller.GovernorateController),
              const SizedBox(height: 16),
              MyTextFormField(
                  validator: () {},
