...
class Adding_a_diet_Screen extends StatelessWidget {
  ...
  final Adding_a_diet_controller _controller = Get.put(Adding_a_diet_controller());
  @override
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() => UploadImageWidget(bacImage: _controller.imagePath.value!)),
                  const SizedBox(
                    height: 14,
                  ),
                  GestureDetector(
                    onTap: () => _controller.initImage(),
                    child: const Text(
                      "Upload image",
                  ...
                  MyTextFormField(
                    controller: _controller.NameOfTheDietControllerAr,
                    validator: () {},
                  ...
                  MyTextFormField(
                    controller: _controller.NameOfTheDietController,
                    validator: () {},
                  ...
                  MyTextFormField(
                      controller: _controller.DescriptionOfTheDietController,
                      multiLines: true,
                      validator: () {},
                  ...
                  MyTextFormField(
                      controller: _controller.componentsOfTheDietController,
                      multiLines: true,
                      validator: () {},
                  ...
                  MyTextFormField(
                    ontap: () async {
                      ...
                      _controller.BeginningOfTheDietTimeController.text = date;
                    },
                    controller: _controller.BeginningOfTheDietTimeController,
                  ...
                  MyTextFormField(
                    ontap: () async {
                      String date = await TimePickDialog.selectTime(context);
                      _controller.EndOfTheDietTimeController.text = date;
                    },
                    controller: _controller.EndOfTheDietTimeController,
                    KeyboardType: TextInputType.number,
                    validator: () {},
